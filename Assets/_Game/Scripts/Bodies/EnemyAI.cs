...
namespace BIG.IncredibleCityCrisis
{
    ...
    public class EnemyAI : MonoBehaviour
    {
        ...
        private string playerJoinButton { get { return player.playerInput.primaryFire; } }
        ...
        private IEnumerator Start()
        {
            ...
            while (true)
            {
                ...
                m_input.primaryAttack = true;
                yield return null;
                m_input.primaryAttack = false;
            }
        }
        ...
        public void GrantPlayerControl()
        {
            ...
            player.PossessBody(this.gameObject);
        }
